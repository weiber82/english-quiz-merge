...
urlpatterns = [
    ...
    path('improve/resolve/', views.resolve_suggestion, name='resolve_suggestion'),
    ...
    path('manage-users/index/', views.manage_users_index_view, name='manage_users_index'),
    path('manage-users/create/', views.manage_users_create_view, name='manage_users_create'),
    path('manage-users/edit/<int:u_id>/', views.manage_users_edit_view, name='manage_users_edit'),
    path('manage-users/delete/<int:u_id>/', views.manage_users_delete_view, name='manage_users_delete'),
    path('analysis/index/', views.analysis_index_view, name='analysis_index_view'),
    path('analysis/submit-suggestion/', views.analysis_submit_improve_suggestion, name='analysis_submit_suggestion'),
    path('quality/index/', views.quality_index_view, name='quality_index_view'),
    path('quality/submit-suggestion/', views.quality_submit_improve_suggestion, name='quality_submit_suggestion'),
